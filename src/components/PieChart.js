...
const PieChart = () => {
  ...
  const getTickets = async () => {
    try {
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Trứng" && i.type == "receive" && i.quantity > 0
            ? (sumeggs += i.quantity)
            : (sumeggs += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Mì Gói" && i.type == "receive" && i.quantity > 0
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Dầu Ăn" && i.type == "receive" && i.quantity > 0
            ? (sumOil += i.quantity)
            : (sumOil += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Quần Áo" && i.type == "receive" && i.quantity
            ? (sumCloth += i.quantity)
            : (sumCloth += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Trứng" && i.type == "send" && i.quantity > 0
            ? (sumeggsS += i.quantity)
            : (sumeggsS += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Mì Gói" && i.type == "send" && i.quantity > 0
            ? (sumNoodleS += i.quantity)
            : (sumNoodleS += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Dầu Ăn" && i.type == "send" && i.quantity > 0
            ? (sumOilS += i.quantity)
            : (sumOilS += 0)
        )
      );
      ...
      tickets.map((t) =>
        t.items.map((i) =>
          i.name == "Quần Áo" && i.type == "send" && i.quantity
            ? (sumClothS += i.quantity)
            : (sumClothS += 0)
        )
      );
      setClothS(sumClothS);
